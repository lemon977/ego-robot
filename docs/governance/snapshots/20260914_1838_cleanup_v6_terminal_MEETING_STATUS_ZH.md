...
- 状态生成时间：`2026-09-14T18:37:33+08:00`
- governance revision：`5840`
- generation id：`gov-005840-afa1846bff49`
- freshness：`FRESH`（age=0s）
- generator code SHA：`69b9dadc69e7d5ef34e1ef134353ac11204c4fadc618ee967e2327b65ece075f`
...
- `exact78_v52_lane_e_baseline_docs` / `-` / `FAILED_RUNTIME_FINAL` / no-result / `2026-09-14T13:21:52+08:00`
