...
- 状态生成时间：`2026-09-13T02:24:39+08:00`
- governance revision：`127`
- generation id：`gov-000127-74659b675c20`
...
|---|---|---|---:|---:|---:|---|---|
| `exact78_wave0_clean_v1` | `get_potato_chips_0902_107` | `wait_gpu_resource` | 0 | 2042087 | - | `2026-09-13T02:24:24+08:00` | `CLAIMED` |
| `exact78_upstream_c_successors_v1` | `get_potato_chips_0902_034` | `wait_gpu_resource` | 1 | 2061080 | - | `2026-09-13T02:24:39+08:00` | `CLAIMED` |
