...
- 状态生成时间：`2026-09-13T02:27:48+08:00`
- governance revision：`142`
- generation id：`gov-000142-313b32eb07d6`
...
|---|---|---|---:|---:|---:|---|---|
| `exact78_wave0_clean_v1` | `get_potato_chips_0902_107` | `wait_gpu_resource` | 0 | 2042087 | - | `2026-09-13T02:27:29+08:00` | `CLAIMED` |
| `exact78_upstream_c_successors_v1` | `get_potato_chips_0902_034` | `wait_gpu_resource` | 1 | 2061080 | - | `2026-09-13T02:27:48+08:00` | `CLAIMED` |
